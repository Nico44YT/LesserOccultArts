...
public class ItemRegistry {
    ...
    public static final Item MALICE_INK = registerItem("clump_of_malice", new MaliceInkItem(new FabricItemSettings().group(ItemRegistry.LOA_ITEM_GROUP)));

    public static final Item DEEEPSLATE_GREATSWORD = registerItem("deepslate_greatsword", new DamnedGreatswordItem(DamnedGreatswordItem.DamnedGreatswordMaterial.INSTANCE,1 ,-2.7f, new FabricItemSettings().group(ItemRegistry.LOA_ITEM_GROUP)));
