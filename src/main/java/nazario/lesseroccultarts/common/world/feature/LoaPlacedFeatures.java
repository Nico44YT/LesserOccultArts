...
public class LoaPlacedFeatures {
    public static final RegistryEntry<PlacedFeature> SILVER_ORE_PLACED = PlacedFeatures.register("silver_ore_placed",
            LoaConfiguredFeatures.SILVER_ORE, modifiersWithCount(7, HeightRangePlacementModifier.trapezoid(YOffset.fixed(0), YOffset.fixed(60))));
